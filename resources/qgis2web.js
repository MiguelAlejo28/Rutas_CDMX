...
map.getView().fit([-11061331.348702, 2160574.607814, -11013969.057820, 2224975.451279], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Propuesta de rutas para la mitigación de inundaciones en la Ciudad de México.</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (297 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Con esta recopilación de capas, se encontró una relación directa entre la cantidad de residuos generados, la topografía y la red de drenaje, sabiendo que uno de los motivos es la obstrucción de la red de drenaje se propusieron rutas para recolectar los tiraderos clandestinos alrededor de la CDMX.';
            }
